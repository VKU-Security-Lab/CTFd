...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p>CTF competition is organized by VSL - VKU Security Lab</p>
            <p>Follow us on social media:</p>
            <a href="https://www.facebook.com/vkuseclab"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://github.com/VKU-Security-Lab"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
        <h4 class="text-center">
            <a href="admin">Click here</a> to login and start your journey!
        </h4>
    </div>
</div>"""
            page.content = index
